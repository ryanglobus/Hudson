	...
	<g:form action="deletePosts">
		...
		<div class="btn-group">
			...
			<ul class="dropdown-menu" role="menu">
				<li><g:link controller="profile" action="newResults"
						params="[queryName: 'all']">All</g:link></li>
				<li class="divider"></li>
		...
		<button type="submit" class="btn btn-danger">
			<span class="glyphicon glyphicon-trash"></span> Delete Selected Posts
		</button>
		<br>
		<br>
		<br>
		<g:if test="${results.size() == 0}">
			<br>
			<p>Looks like you have new posts at this time, but we'll keep
				looking!</p>
		</g:if>
		<g:else>
			<g:each var="postList" in="${results}">
				<div class="panel panel-default" style="padding-top: 400px">
					...
					<div class="panel-heading">
						<h3>
							...
							<button type="button" class="btn btn-danger">
								<g:link action="deleteQuery" params="[queryName: postList.key]">
									<span class="glyphicon glyphicon-trash"></span> Delete Query</g:link>
							</button>
						</h3>
					</div>
					<!-- Table -->
